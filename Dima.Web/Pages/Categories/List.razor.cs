    ...
    public partial class ListCategoriesPage : ComponentBase
    {
        ...
        public Func<Category, bool> Filter => category =>
        {
            ...
            if (category.Id.ToString().Contains(SearchTerm, StringComparison.OrdinalIgnoreCase)
                ...
                || category.Description.Contains(SearchTerm, StringComparison.OrdinalIgnoreCase)) return true;
        ...
        {
            var result = await DialogService.ShowMessageBox("Atenção", $"Ao prosseguir a categoria {title} será excluída. Esta é uma ação irreversível, deseja continuar?",yesText:"Excluir",cancelText:"Cancelar");
